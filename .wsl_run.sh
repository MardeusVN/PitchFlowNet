...
REPO=/home/dev/PitchFlowNet

echo "--- syncing code from Windows ---"
rsync -a --exclude='.git' --exclude='data' --exclude='notebooks' \
    /mnt/c/Users/duyng/OneDrive/Documents/Repository/FPT-Graduation-Project/PitchFlowNet/ "$REPO/"

echo "--- syncing dataset from Windows (this can take a while, 3.6GB) ---"
mkdir -p /home/dev/data
rsync -a --info=progress2 \
    /mnt/c/Users/duyng/OneDrive/Documents/Repository/FPT-Graduation-Project/PitchFlowNet/data/ /home/dev/data/
